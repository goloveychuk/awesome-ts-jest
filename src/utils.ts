...
function isFileEmit(fileName:string, outputFileName: string, sourceFileName: string) {
...
function isSourceMapEmit(fileName: string, outputFileName: string, sourceFileName: string) {
    return compareFileName(sourceFileName, fileName)
        // typescript now emits .jsx files for .tsx files.
        && (
...
function isDeclarationEmit(fileName: string, outputFileName: string, sourceFileName: string) {
    return compareFileName(sourceFileName, fileName)
